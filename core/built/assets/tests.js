...
define('ghost/tests/helpers/file-upload', ['exports', 'ember'], function (exports, _ember) {
...
define('ghost/tests/helpers/start-app', ['exports', 'ember', 'ghost/app', 'ghost/config/environment', 'ghost/tests/helpers/file-upload'], function (exports, _ember, _ghostApp, _ghostConfigEnvironment, _ghostTestsHelpersFileUpload) {
...
define('ghost/tests/integration/components/gh-file-uploader-test', ['exports', 'chai', 'ember-mocha', 'ember', 'pretender', 'ember-test-helpers/wait', 'sinon', 'ghost/tests/helpers/file-upload'], function (exports, _chai, _emberMocha, _ember, _pretender, _emberTestHelpersWait, _sinon, _ghostTestsHelpersFileUpload) {
    var _slicedToArray = (function () { function sliceIterator(arr, i) { var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i['return']) _i['return'](); } finally { if (_d) throw _e; } } return _arr; } return function (arr, i) { if (Array.isArray(arr)) { return arr; } else if (Symbol.iterator in Object(arr)) { return sliceIterator(arr, i); } else { throw new TypeError('Invalid attempt to destructure non-iterable instance'); } }; })();
    ...
    (0, _emberMocha.describeComponent)('gh-file-uploader', 'Integration: Component: gh-file-uploader', {
        ...
        (0, _emberMocha.it)('generates request to supplied endpoint', function (done) {
            ...
            (0, _ghostTestsHelpersFileUpload.fileUpload)(this.$('input[type="file"]'));
        ...
        (0, _emberMocha.it)('triggers file upload on file drop', function (done) {
            ...
            var drop = _ember['default'].$.Event('drop', {
                dataTransfer: {
                    files: [(0, _ghostTestsHelpersFileUpload.createFile)()]
                }
            });
...
/* jshint expr:true */
define('ghost/tests/integration/components/gh-image-uploader-test', ['exports', 'ember', 'sinon', 'chai', 'ember-mocha', 'pretender', 'ember-test-helpers/wait', 'ghost/tests/helpers/file-upload'], function (exports, _ember, _sinon, _chai, _emberMocha, _pretender, _emberTestHelpersWait, _ghostTestsHelpersFileUpload) {
    var _slicedToArray = (function () { function sliceIterator(arr, i) { var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i['return']) _i['return'](); } finally { if (_d) throw _e; } } return _arr; } return function (arr, i) { if (Array.isArray(arr)) { return arr; } else if (Symbol.iterator in Object(arr)) { return sliceIterator(arr, i); } else { throw new TypeError('Invalid attempt to destructure non-iterable instance'); } }; })();
